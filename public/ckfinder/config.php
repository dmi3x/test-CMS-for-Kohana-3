...
/*if(@$_SESSION['siteID']) 
{
    $baseUrl = '/clients/'.$_SESSION['siteID'].'/uploads/content/';
	$baseDir = 'S:/home/firms-test.com.ua/test/clients/'.$_SESSION['siteID'].'/uploads/content/';
}
*/
...
//$space = 1024*1024*5;  //5 Mb
//$dirsize = getDirSize($baseDir);
//$is_space = ($dirsize>=$space) ? false : true;
$is_space = true;
